...
class OminiModel(L.LightningModule):
    def __init__(
        ...
        try:
            # 直接从本地加载模型
            print(f"Loading model from: {flux_pipe_id}")
            ...
            # 打印 text_encoder 和 text_encoder_2 的结构信息
            # print("Text Encoder Structure:")
            # print(self.flux_pipe.text_encoder)
            # print("Text Encoder 2 Structure:")
            # print(self.flux_pipe.text_encoder_2)
